...
export const Header = () => {
    return (
        <header>
            <nav className="bg-[#FF8225] border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
            ...
            <nav className="bg-[#F8EDED] border-gray-200 py-2.5 dark:bg-gray-800 flex justify-center">
                    ...
                    <div className="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1 gap-20">
                        <a href="/" className="flex flex-row gap-2 items-center">
                            ...
                            <div className="flex flex-col gap-0 text-left">
                                <span className="text-md font-semibold text-[#173B45]">0123 456 789</span>
                                <span className="text-sm font-light text-black">SDT Hỗ Trợ</span>
                            </div>
                        </a>
                        <a href="/" className="flex flex-row gap-2 items-center">
                            <Image src="https://cdn-icons-png.flaticon.com/128/819/819865.png" alt="location" width={32} height={32} />
                            <div className="flex flex-col gap-0 text-left">
                                <span className="text-md font-semibold text-[#173B45]">Cần Thơ</span>
                        ...
                        <a href="/" className="flex flex-row gap-2 items-center">
                            ...
                            <div className="flex flex-col gap-0 text-left">
                                <span className="text-md font-semibold text-[#173B45]">hotro.inanhtructuyen@gmail.com</span>
                                <span className="text-sm font-light text-black">Email hỗ trợ</span>
                            </div>
                        </a>
                    </div>
                    <div className="flex items-center lg:order-2 gap-4">
                        <a href="#" className="hidden md:block lg:block text-[#173B45] font-medium rounded-lg text-[14px]">ĐĂNG NHẬP</a>
                        ...
                        <a href="https://play.google.com/store/search?q=lightroom&c=apps&hl=vi" target="_blank" className="flex flex-row gap-1 bg-[#B43F3F] text-white px-8 py-2 rounded-full">
                            Tải App
                        </a>
                    </div>
                </div>
