...
export const Footer = () => {
    return (
        <footer className="bg-[#F8F3EF] py-8">
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-5 gap-5">
                    ...
                    <div>
                        <h3 className="text-lg font-semibold mb-4 text-center">CÁCH THỨC THANH TOÁN</h3>
                        <div className="flex justify-center items-center space-x-2">
                            <img src="https://inanhvietnam.com/image/payment.jpg" alt="thanh_toan" className="w-4/5" />
                        </div>
                    </div>
                    <div>
                        <h3 className="text-lg text-center font-semibold mb-4">KẾT NỐI VỚI CHÚNG TÔI</h3>
                        <div className="flex justify-center items-center space-x-2">
                            <svg width="36px" height="36px" viewBox="0 0 48 48" version="1.1" xmlns="http://www.w3.org/2000/svg" fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <title>Facebook-color</title> <desc>Created with Sketch.</desc> <defs> </defs> <g id="Icons" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"> <g id="Color-" transform="translate(-200.000000, -160.000000)" fill="#4460A0"> <path d="M225.638355,208 L202.649232,208 C201.185673,208 200,206.813592 200,205.350603 L200,162.649211 C200,161.18585 201.185859,160 202.649232,160 L245.350955,160 C246.813955,160 248,161.18585 248,162.649211 L248,205.350603 C248,206.813778 246.813769,208 245.350955,208 L233.119305,208 L233.119305,189.411755 L239.358521,189.411755 L240.292755,182.167586 L233.119305,182.167586 L233.119305,177.542641 C233.119305,175.445287 233.701712,174.01601 236.70929,174.01601 L240.545311,174.014333 L240.545311,167.535091 C239.881886,167.446808 237.604784,167.24957 234.955552,167.24957 C229.424834,167.24957 225.638355,170.625526 225.638355,176.825209 L225.638355,182.167586 L219.383122,182.167586 L219.383122,189.411755 L225.638355,189.411755 L225.638355,208 L225.638355,208 Z" id="Facebook"> </path> </g> </g> </g></svg>
                ...
                <div className="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div>
                        <h3 className="text-lg font-semibold mb-4">CỬA HÀNG HỒ CHÍ MINH</h3>
                        <ul className="space-y-2 text-sm">
                            <li>Store Quận 1: 235 Lý Tự Trọng, Q1, HCM. </li>
                            <li>Store Quận 10: 152/30 Thành Thái, Q10, HCM. </li>
                            <li>Store Quận Tân Bình: 163 Nguyễn Thái Bình, HCM. </li>
                            <li>Xưởng sản xuất: 152/10 Thành Thái, Q10, HCM. </li>
                        </ul>
                    </div>
                    <div className="text-sm">
                        <div className="mt-4 lg:mt-0">
                            <p className="mb-2">Copyright 2020 IN ẢNH TRƯC TUYẾN | CÔNG TY FARMCODE.</p>
                        </div>
                    </div>
                </div>
            </div>
