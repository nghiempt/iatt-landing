...
export const Footer = () => {
    return (
        <footer className="w-full bg-[#F8EDED] pt-8 flex justify-center">
            <div className="w-5/6">
                <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-5">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm">
                            ...
                            <li>Xưởng sản xuất và đóng gói</li>
                            <li>Video Review</li>
                            <li>Blog</li>
                        </ul>
                    </div>
                ...
                <div className="w-full mt-12 pb-4 flex flex-col justify-center items-center">
                    <div className="text-sm">
                        <div className="text-center">
                            <p>Copyright 2024 IN ẢNH TRƯC TUYẾN</p>
                        </div>
                    </div>
                </div>
            </div>
