...
export default function AnhDeBanPage() {
    return (
                ...
                <div className="w-full flex justify-center">
                    <div className="flex flex-col w-5/6 justify-center">
                        <div className="flex flex-row gap-4 justify-between my-3">
                            ...
                            <Link href="/anh-de-ban" className="text-[#6B1346] font-normal text-md p-2 border-b-2 border-[#6B1346]">ẢNH ĐỂ BÀN</Link>
                        ...
                        <div className="flex flex-row text-start text-md gap-3">
                            ...
                            <Link href="/anh-de-ban">Ảnh để bàn</Link>
                        </div>
                        <div className="w-full justify-center mb-10">
                            <div className="py-5 mb-5 text-center text-3xl font-semibold text-[#6B1346]">Ảnh để bàn</div>
