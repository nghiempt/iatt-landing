...
const ImageUploadAlbum = ({ onImageChange, className }: ImageUploadAlbumProps) => {
            ...
            {!preview ? (
                ...
                >
                    <div className="flex flex-col items-center gap-2">
                        <svg className="h-8 w-8" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
